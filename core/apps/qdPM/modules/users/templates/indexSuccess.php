...
<table width="100%">
  <tr>
    <td><?php  echo $lc->insert_button(__('Add a New User')) . ' '.  button_tag_mmodalbox(__('Export Selected'),'users/export') ?></td>
...
<table class="table table-striped table-hover" id="table-users">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style=""><?php echo renderUserPhoto($users->getPhoto()) ?></td>
