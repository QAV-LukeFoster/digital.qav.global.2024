...
class cfgListingController
{
  ...
  public function sort_button()
    ...
    return '<button class="btn btn-info" onClick="openModalBox(\'' . url_for('app/sortItems?t=' . $this->module . $this->add_url_params('&') ,true) . '\')">' . __('Sort') . '</button>';
  }
  ...
  public function delete_mbutton($id)
	{
    return link_to_modalbox('<i class="fa fa-trash-o"></i>',$this->module  . '/delete?id='  . $id  . $this->add_url_params('&'),'class="btn btn-danger btn-xs purple"');
  }
